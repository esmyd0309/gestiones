                                    ...
                                    <form  v-on:submit.prevent="checkForm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div>
                                                    <input type="number" class="form-control"  v-model="form.telefono2">
                                                </div>
                                            </div>
                                            <div class="col">
    ...
    export default  {
        ...
        data() {
              return {
                ...
                telefono1: '',
                page: 0,
                url: 'http://localhost:8080/gestiones/public/listacontactos',
                errors: [],
                idContacto: null,
                provincias: null,
                cantones: null,
        ...
        created(){
                ...
                axios.get('http://localhost:8080/gestiones/public/getprovincia')
                            .then(res => {
         ...
         mounted() {
          ...
          methods: {
            ...
            search(){
                let me = this
                let url2 ='http://localhost:8080/gestiones/public/contactos'
                axios.get(`${url2}?telefono1=${me.telefono1}`)
                    .then(res => {
                        me.clientes = res.data.data
                        me.page = res.data.current_page
                        console.log(me.page)
            ...
            ejecutar(item){
                ...
                this.idContacto=item;
                        axios.get('consultarcontacto/'+item.id)
                            .then(res => {
            ...
            getCanton(event){
                axios.get('contactos/getcanton/'+event)
                            .then(res => {
            ...
            getSector(event){
                                ...
                                console.log(event)
                axios.get('contactos/getSector/'+event)
                            .then(res => {
            ...
            checkForm: function(){
               this.errors = [];
                ...
                if(this.form.telefonowhatsapp  && this.form.nombre && this.form.direccion){
                    this.agregar();
                }
             ...
             agregar(){
                ...
                axios.post('guardarcontacto',parametros)
                .then(res => {
