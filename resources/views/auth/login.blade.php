                ...
                <div class="p-5">
                  ...
                  <form method="POST" action="{{ route('login') }}" class="user">
                    ...
                    <div class="form-group">
                      ...
                      <input id="usuario" type="text" value="{{ old('usuario') }}"  class="form-control form-control-user" name="usuario" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Usuario..." required autofocus>
                    </div>
                    <div class="form-group">
                      {!! $errors->first('password', '<span style="color:red">:message</span>') !!}
                      <input id="password" type="password" name="password" class="form-control form-control-user" id="exampleInputPassword"  placeholder="Contraseña" required>
                    </div>
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" id="customCheck">
                        <label class="custom-control-label" for="customCheck">Guardar Credenciales</label>
                      </div>
                    </div>
                    <button class="btn btn-primary btn-user btn-block" type="submit" class="btn btn-primary">Acceder</button>
                  ...
                  <div class="text-center">
                    <a class="small" href="{{ route('users.create') }}" hidden>Crear Nuevo Usuario!</a>
                  </div>
                </div>
              </div>
            </div>
